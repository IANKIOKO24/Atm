		  ...
		  try
		   {
		     ...
		     con=DriverManager.getConnection("jdbc:mysql://localhost:8080/atmdb","root","");
...
JOptionPane.showMessageDialog(this,"Your balance is less,You should keep minimum balance 1000 RS","Warning",JOptionPane.WARNING_MESSAGE);
	      ...
	      {
	JOptionPane.showMessageDialog(this,"Your can not withdraw per day greater than 25000 ksh","Warning",JOptionPane.WARNING_MESSAGE);
	       sound.play();
	       t1.setText("");
	      }//
	     }
	     else
	     {
		   ...
		   if(givam<100)
    		{
           JOptionPane.showMessageDialog(this,"You can not withdraw amount less than 100 Ksh!","Warning",JOptionPane.WARNING_MESSAGE);
            sound.play();
            t1.setText("");
			}
			else if(givam>10000)
			{
     	JOptionPane.showMessageDialog(this,"You can not withdraw amount greater than 10000 ksh at the same time!","Warning",JOptionPane.WARNING_MESSAGE);
            sound.play();
             t1.setText("");
		    }
			else if(givam>100 && (!(givam % 100 ==0)))
...
JOptionPane.showMessageDialog(this,"Your balance is less to withdraw amount","Warning",JOptionPane.WARNING_MESSAGE);
	           ...
	           {
JOptionPane.showMessageDialog(this,"Your balance is less,You should keep minimum balance 1000 ksh","Warning",JOptionPane.WARNING_MESSAGE);
	           sound.play();
	           t1.setText("");
	           }
	         }
	      ...
	      {
	 JOptionPane.showMessageDialog(this,"Your can not withdraw per day greater than 50000 ksh","Warning",JOptionPane.WARNING_MESSAGE);
	       sound.play();
	       t1.setText("");//
	      }
	      }
